...
\begin{align}
    ...
    \implies X\brak z &= \dfrac{8}{1-z^{-1}} + \dfrac{8z^{-1}}{{(1-z^{-1})}^{2}} \\
    &= \dfrac{8}{({1-z^{-1})}^{2}} , \;|z|>1    \\
    y\brak{n}&=x\brak{n}\ast u\brak{n}\\
    Y\brak{z}&=X\brak{z}U\brak{z}   \\
    \implies Y\brak{z}&=\brak{\dfrac{8}{({1-z^{-1})}^{2}}}\brak{\dfrac{1}{1-z^{-1}}}  \\
    &=\dfrac{8}{({1-z^{-1})}^{3}} , \;|z|>1
 \end{align}
 Using Contour Integration to find the inverse $Z$-transform,
\begin{align}
    \implies y(14)&=\dfrac{1}{2\pi j}\oint_{C}Y(z) \;z^{13} \;dz  \\
